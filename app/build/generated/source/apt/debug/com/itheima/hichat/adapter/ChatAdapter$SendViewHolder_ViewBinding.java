...
public class ChatAdapter$SendViewHolder_ViewBinding<T extends ChatAdapter.SendViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public ChatAdapter$SendViewHolder_ViewBinding(T target, View source) {
    this.target = target;
    ...
    target.ivMsgState = Utils.findRequiredViewAsType(source, R.id.iv_msg_state, "field 'ivMsgState'", ImageView.class);
  }
